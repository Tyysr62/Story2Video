...
from app.core.config import COMFY_HOSTS_LIST, COMFY_INPUT_DIR, COMFY_OUTPUT_DIR, LOCAL_INFERENCE, PIXVERSE_API_KEY, PIXVERSE_UPLOAD_URL, PIXVERSE_GENERATE_URL, PIXVERSE_RESULT_URL
...
def run_i2v(start_image: Path, text_prompt: str, target_path: Path, workflow_i2v: Dict, user_id: str | None = None, story_id: str | None = None, lip_sync_tts_content: str | None = None) -> bool:
    if LOCAL_INFERENCE:
        ...
        try:
            ...
            res_headers = { 'API-KEY': PIXVERSE_API_KEY, 'Ai-trace-id': trace_id }
            tries = 0
            while tries < 600:
