...
ENHACE_LIST: List[str] = [
    url for url in [
        os.getenv("ENHACE_URL_1", ""),
        os.getenv("ENHACE_URL_2", ""),
        os.getenv("ENHACE_URL_3", ""),
        os.getenv("ENHACE_URL_4", ""),
    ]
    if url
]
...
QIANFAN_CREATE_URL: str = os.getenv("QIANFAN_CREATE_URL", "")
QIANFAN_QUERY_URL: str = os.getenv("QIANFAN_QUERY_URL", "")
QIANFAN_MODEL: str = os.getenv("QIANFAN_MODEL", "")
QIANFAN_DURATION: int = int(os.getenv("QIANFAN_DURATION", ""))
QIANFAN_POLL_INTERVAL: int = int(os.getenv("QIANFAN_POLL_INTERVAL", ""))
QIANFAN_MAX_POLL_TIMES: int = int(os.getenv("QIANFAN_MAX_POLL_TIMES", ""))
QIANFAN_MAX_CONCURRENCY: int = int(os.getenv("QIANFAN_MAX_CONCURRENCY", ""))

# Pixverse API 配置
PIXVERSE_MAX_CONCURRENCY: int = int(os.getenv("PIXVERSE_MAX_CONCURRENCY", ""))
PIXVERSE_API_KEY: str = os.getenv("PIXVERSE_API_KEY", "")
PIXVERSE_UPLOAD_URL: str = os.getenv("PIXVERSE_UPLOAD_URL", "")
PIXVERSE_GENERATE_URL: str = os.getenv("PIXVERSE_GENERATE_URL", "")
PIXVERSE_RESULT_URL: str = os.getenv("PIXVERSE_RESULT_URL", "")
